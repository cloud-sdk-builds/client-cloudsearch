...
[`@aws-sdk/client-cloudsearch`](https://www.npmjs.com/package/@aws-sdk/client-cloudsearch/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudsearch@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HUI8A8uiszSlbSXYkZVg4ndGIUSZv+keAxErKmf3Vz2+YrGVM8ItwoaRrWB2KXNx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudsearch": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudsearch@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudsearch@3.896.0/index.min.mjs": "sha384-HUI8A8uiszSlbSXYkZVg4ndGIUSZv+keAxErKmf3Vz2+YrGVM8ItwoaRrWB2KXNx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudsearch/blob/refs/tags/3.896.0/LICENSE
```
