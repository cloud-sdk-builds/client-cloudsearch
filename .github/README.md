...
[`@aws-sdk/client-cloudsearch`](https://www.npmjs.com/package/@aws-sdk/client-cloudsearch/v/3.806.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudsearch@3.806.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-K4k6E1MjZV703FiPLMvbAnghgAlB565NITLx+F0mDo42v2yl1b6ig4m4EO/eThkR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudsearch": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudsearch@3.806.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudsearch@3.806.0/index.min.mjs": "sha384-K4k6E1MjZV703FiPLMvbAnghgAlB565NITLx+F0mDo42v2yl1b6ig4m4EO/eThkR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudsearch/blob/refs/tags/3.806.0/LICENSE
```
