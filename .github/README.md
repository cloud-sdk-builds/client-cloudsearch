...
[`@aws-sdk/client-cloudsearch`](https://www.npmjs.com/package/@aws-sdk/client-cloudsearch/v/3.210.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudsearch@3.210.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QnJAirxp5cWixVCM3lGFQIX25APUIHg81M3y6hty+REZiXwx5nh/0N+E3jVcrXAt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloudsearch": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudsearch@3.210.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloudsearch@3.210.0/index.min.mjs": "sha384-QnJAirxp5cWixVCM3lGFQIX25APUIHg81M3y6hty+REZiXwx5nh/0N+E3jVcrXAt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloudsearch/blob/refs/tags/3.210.0/LICENSE
```
